...
https://www.youtube.com/watch?v=hqjOY8YHdlM
...
This fires every time the local node makes a new connection.<br/>
The callback has the following structure…
...
Sends msg to every node on the entire mesh network.<br/>
...
Sends msg to the node with Id == dest.<br/>
Returns true if everything works, false if not.  Prints an error message to Serial.print, if there is a failure.
